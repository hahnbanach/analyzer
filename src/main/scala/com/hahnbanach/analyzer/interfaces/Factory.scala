package com.hahnbanach.analyzer.interfaces
import com.hahnbanach.analyzer.atoms.AbstractAtomic
import com.hahnbanach.analyzer.operators.AbstractOperator
